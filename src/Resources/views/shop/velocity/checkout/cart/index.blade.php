                                    ...
                                    @foreach ($cart->items as $key => $item)
                                        ...
                                        <div class="row col-12" v-if="!isMobileDevice">
                                            ...
                                            @foreach($productLabels as $productlab)
                                                ...
                                                @if( $productlab['product_url_key'] == $product->url_key)
                                                    <div class="{{ $productlab['position'] }} product-label-image" title="{{$productlab['title']}}">
                                                        <img src="{{$url}}/storage/{{$productlab['image']}}" class="product-label"/>
                                                    </div>
                                                @endif
                                            @endforeach
                                        ...
                                        <div class="row col-12" v-else>
                                            <a
                                                ...
                                                @if( $productlab['product_url_key'] == $product->url_key)
                                                    <div class="{{ $productlab['position'] }} product-label-image" title="{{$productlab['title']}}">
                                                        <img src="{{$productlab['image']}}" class="product-label"/>
                                                    </div>
                                                @endif
                                            @endforeach
                                            </a>

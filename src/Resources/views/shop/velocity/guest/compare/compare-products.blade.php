                                ...
                                @switch ($attribute['code'])
                                    ...
                                    @case('name')
                                        <a :href="`${$root.baseUrl}/${product.url_key}`" class="unset remove-decoration active-hover">
                                            <h1 class="fw6 fs18" v-text="product['{{ $attribute['code'] }}']" class="`${index}`"></h1>
                                        </a>
                                        @break
                                    ...
                                    @case('product_image')
                                        ...
                                        <div v-for="productlab in productLabs">   
                                            <div v-if="`${productlab.product_url_key}` == `${product.url_key}`" >
                                                <div :class="productlab.position" class="product-label-image-compare" :title="`${productlab.title}`">
                                                    <img :src="`${addImage}/${productlab.image}`" class="product-label-compare"/>
                                                </div>                
                                            </div>
                                        </div>

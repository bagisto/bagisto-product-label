...
@php
    ...
    $productLabel = (app('Webkul\ProductLabelSystem\Repositories\ProductLabelImageRepository')->getProductsLabel($product->id));
...
{!! view_render_event('bagisto.shop.products.list.card.before', ['product' => $product]) !!}
    @if (isset($list) && $list)
        <div class="col-12 lg-card-container list-card product-card row">
            <div class="product-image">
                ...
                @include ('productlabelsystem::shop.products.list.imagelabelview', ['productId' => $product->id])
    ...
    @else
        <div class="card grid-card product-card-new">
            ...
            @include ('productlabelsystem::shop.velocity.products.list.imagelabelview', ['productId' => $product->id])

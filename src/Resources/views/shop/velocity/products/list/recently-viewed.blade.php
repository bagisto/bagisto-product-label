                ...
                <div
                    ...
                    <div class="col-4 product-image-container mr15">
                        ...
                        <div v-for="productlab in productLabs">   
                            <div v-if="productlab.product_url_key == `${product.urlKey}`" >
                                <div :class="productlab.position" class="product-label-image-recent" :title="`${productlab.title}`">
                                    <img :src="`${addImage}/${productlab.image}`" class="product-label-recent"/>
                                </div>                
                            </div>
                        </div>
                        </a>

...
@php
    ...
    $productLabels = (app('Webkul\ProductLabelSystem\Repositories\ProductLabelImageRepository')->getProductsLabel($product->id));
...
{!! view_render_event('bagisto.shop.products.view.gallery.before', ['product' => $product]) !!}
    ...
    <div class="product-image-group">
        ...
        <div class="row col-12">
            ...
            @include ('productlabelsystem::shop.velocity.products.views.imagelabelview', ['productId' => $product->id])
            <img
                v-else

...
<div class="default-label-image-gallery {{ $productLabel[0]->position }}" title="{{$productLabel[0]->title}}">
    <img src="{{ asset("storage/".$productLabel[0]->image) }}" class="default-label-gallery"/>
</div>

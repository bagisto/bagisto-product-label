...
@push('css')
    <style type="text/css">
        ...
        .default-label-image.Top-Left{
            margin-top: -150px;
            margin-left: 0;
        }
        .default-label-image.Top-Right{
            margin-top: -150px;
            margin-left: 140px;
        }
        .default-label-image.Bottom-Left{
            margin-top: -45px;
            margin-left: 0;
        }
        .default-label-image.Bottom-Right{
            margin-top: -45px;
            margin-left: 150px;
        }
        .None{
                                ...
                                <div class="item mt-5">
                                    <div class="item-image" style="margin-right: 15px;">
                                        ...
                                        @php
                                            $url = URL::to("/");
                                            @endphp
                                            @foreach($productLabels as $productlab)
                                             
                                                @if( $productlab['product_url_key'] == $url_key)
                                                    <div class="{{ $productlab['position'] }} default-label-image" title="{{$productlab['title']}}">
                                                        <img src="{{$url}}/storage/{{$productlab['image']}}" style="height: 25px; width: 25px" />
                                                    </div>
                                                @endif
                                            @endforeach
                                    </div>

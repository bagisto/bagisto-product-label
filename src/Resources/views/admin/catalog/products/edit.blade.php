    ...
    <div class="content">
        ...
        <form method="POST" action="" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                ...
                <accordian :title="'{{ __('productlabelsystem::app.product_edit.product_label_image') }}'" :active="false">
                    <div slot="body">
                        <div class="control-group">
                        
                            @include('productlabelsystem::admin.catalog.products.productlabeltable', ['product' => $product])
                        </div>           
                    </div>
                </accordian>

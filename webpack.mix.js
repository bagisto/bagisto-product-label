...
mix.js([__dirname + '/src/Resources/assets/js/app.js'], 'js/app.js')
    ...
    .sass(__dirname + '/src/Resources/assets/sass/product-label.scss', 'css/product-label.css')
    .sass(__dirname + '/src/Resources/assets/sass/velocity.scss', 'css/velocity.css')
    .sass(__dirname + '/src/Resources/assets/sass/product-label-default.scss', 'css/product-label-default.css')
    .options({
